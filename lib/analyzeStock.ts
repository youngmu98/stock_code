...
{"score":0~100,"reasoning":"RSI {값}으로 {과매수/과매도/중립} 상태. {뉴스가 주가에 미치는 영향 1문장}. 단기 전망: {매수/매도/관망 근거와 방향성 1문장}. 총 80자 내외.","newsSummaries":["뉴스 헤드라인의 핵심 내용을 한국어로 설명. 무슨 일이 있었는지 구체적으로. 50자 내외.","뉴스2 같은 방식으로",...]}

reasoning은 반드시 80자 내외 한국어. newsSummaries는 각 뉴스가 어떤 내용인지 구체적으로 설명 (단순 번역X, 핵심 사실 위주, 50자 내외). 모든 텍스트 반드시 한국어.`
      ...
      // 429는 캐시하면 안 됨 → throw해서 API 라우트에서 재시도 유도
...
export const analyzeStock = unstable_cache(_analyzeStock, ['stock-analysis-v12'], {
  revalidate: 300,
})
